...
\caption{Wall time to solve (log scale), xfill vs.\ orca-solver, per scraped $15\times15$ grid both solved. Label is orca-solver time / xfill time; only \texttt{grid\_479} favors orca-solver.}
\label{fig:speedup}
\end{figure}
